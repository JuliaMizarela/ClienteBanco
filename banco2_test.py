...
class banco_test(unittest.TestCase):
    ...
    def test_nao_cria_cliente_tel(self):
        try:
    ...
    def test_nao_cria_cliente_mail(self):
        try:
    ...
    def test_set_telefone_erro(self):
        c = Cliente('nome', 99999999, 'email@mail.com')
        try:
